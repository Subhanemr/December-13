...
namespace _13_12_23.Services.Implementations
{
    public class CategoryService : ICategoryService
    {
        ...
        {
            await _repository.AddAsync(new Category { Name = createCategoryDto.Name });
        ...
        public async Task<ICollection<GetCategoryDto>> GetAllByOrderAsync(int page, int take,Expression<Func<Category, object>>? orderExpression)
        {
        ...
        public async Task UpdateAsync(int id, CreateCategoryDto createCategoryDto)
        {
            Category category = await _repository.GetByIdAsync(id);
